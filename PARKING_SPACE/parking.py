...
cap=cv2.VideoCapture('C:\Computer_vision\PARKING_SPACE\carPark.mp4')

with open('C:\Computer_vision\PARKING_SPACE\CarParkPos','rb') as f:
...
def check(imgPro):
    ...
    text = f'Free space: {spaceCount}/{len(posList)}'
    print(text)
    # engine.say(text)
    # engine.runAndWait()
