...
while True:
    ...
    if res.multi_hand_landmarks:
        for handlms in res.multi_hand_landmarks:
            for id,lm in enumerate(handlms.landmark):
                ...
                #print(lmlist)
                draw.draw_landmarks(image,handlms,mphands.HAND_CONNECTIONS,draw.DrawingSpec(color=(0,255,0),thickness=8,circle_radius=4))
    ...
    if len(lmlist)!=0 and len(lmlist)==21:
        ...
        if len(fingerlist)!=0:
            ...
            print(fingercount)  
        cv2.putText(image,str(fingercount),(25,430),cv2.FONT_HERSHEY_COMPLEX_SMALL,4,(0,0,0),5)      
    # print(fingerlist)
