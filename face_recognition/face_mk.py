...
# image = face_recognition.load_image_file("C:\Computer_vision\face_recognition\obama.jpg")
image=cv2.imread(r'C:\Computer_vision\face_recognition\obama.jpg')
...
for face_landmarks in face_landmarks_list:
    ...
    d = ImageDraw.Draw(pil_image, 'RGBA')    # A for alpha 
